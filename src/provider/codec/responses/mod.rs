...
impl Item {
    ...
    fn build(
        ...
        let position = crate::provider::codec::common::position(index)?;
            ...
            parts
                ...
                .map(|(part, content)| {
                    ...
                    Ok(TextBlock {
                        ...
                        position: crate::provider::codec::common::position(*part)?,
                        text: text.to_owned(),
                    })
                })
        ...
        Ok(match &self.body {
            ...
            ItemBody::Reasoning(state) => AssistantItem::Reasoning {
                ...
                position,
                blocks: blocks(&state.parts)?,
                replay: state.snapshot.as_ref().map(|native| {
                    replay(
...
pub(crate) struct Decoder {
    ...
    metadata_events: &'static [&'static str],
    errors: ErrorSignals,
    model: String,
    scope: Scope,
